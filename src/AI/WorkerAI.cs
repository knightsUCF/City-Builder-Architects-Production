...
public class WorkerAI : MonoBehaviour
{
    ...
    */
    ...
    float GetDistanceFromDestination()
    {
        ...
        return Vector3.Distance(this.transform.position, currentWorkerDestination); // will need to be rewritten to manage different workers by IDs
    }
    ...
    */
    ...
    /* disabling clicking on AI worker
    void MoveWorker()
    {
